...
${OBJECTDIR}/Simbolo.o: Simbolo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simbolo.o Simbolo.cpp

${OBJECTDIR}/TDA_Cola.o: TDA_Cola.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA_Cola.o TDA_Cola.cpp

${OBJECTDIR}/TDA_Lista.o: TDA_Lista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA_Lista.o TDA_Lista.cpp

${OBJECTDIR}/TDA_Pila.o: TDA_Pila.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TDA_Pila.o TDA_Pila.cpp
